...
export default function ContactPage() {
    ...
    return (
        <div ref={container} className="min-h-screen pt-32 pb-20 px-8 flex items-center justify-center">
            <div className="w-full max-w-2xl bg-neutral-900/50 p-8 md:p-16 rounded-3xl backdrop-blur-xl border border-white/5 relative overflow-hidden">
